...
function Add_Edit_User() {
	...
	if ($_POST['User_Password'] != $_POST['Confirm_User_Password']) {$user_update = array("Message_Type" => "Error", "Message" => __("The passwords you entered did not match.", 'front-end-only-users')); return $user_update;}
