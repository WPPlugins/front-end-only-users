	...
	if (!isset($ConfirmationSuccess)) {	
		...
		foreach ($Fields as $Field) {
			...
			if ($Field->Field_Type == "label") {
				...
				$ReturnString .= "<label for='" . $Field->Field_Name . "' id='ewd-feup-register-" . $Field->Field_ID . "' class='ewd-feup-field-label'>" . __($Field->Field_Name, 'front-end-only-users'). ":" . $Req_Symbol . "</label>";
			}
